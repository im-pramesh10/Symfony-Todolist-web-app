...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Todoitems::class, mappedBy="user", orphanRemoval=true)
     */
    private $todoitems;
    ...
    /**
     * @return Collection<int, Todoitems>
     */
    ...
    public function addTodoitem(Todoitems $todoitem): self
    {
    ...
    public function removeTodoitem(Todoitems $todoitem): self
    {
